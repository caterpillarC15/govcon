...
- **2026-05-09** — Adopted `hermes-agent` (Nous Research) as agent brain/runtime. OpenClaw narrowed to optional channel/tool substrate. Track A should not build two peer agent brains. PRD bumped to v1.2.2. See `HERMES.md`.
