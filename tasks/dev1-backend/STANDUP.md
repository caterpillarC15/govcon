...
- [x] A2 — `api/db/{__init__.py, models.py}`; schema originally shipped via Alembic `0001_initial` (since removed — **Supabase migrations** under `supabase/migrations/` + `supabase db push` are canonical).
