...
Build a fully responsive, full-viewport hero section for a PR-agency SaaS called "SAAS Software" with these exact specs:
...
Headline <h1> with inline style fontSize: clamp(36px, 8vw, 72px); lineHeight: 1.05; fontWeight: 500; letterSpacing: -0.02em, mt-5 sm:mt-6 max-w-4xl:"Shaping " + <span style={{fontFamily:"'Instrument Serif', serif", fontStyle:"italic", fontWeight:400}}>Agencies</span> + <br> + "of tomorrow"
...
Two label+dropdown groups (label 12px neutral-700, button bordered rounded-lg px-3 py-2 with ChevronDown):"Show figures for" → "This month"
"Compare period by" → "Month-to-date (MTD)"

Two label+input groups with # prefix:"Ste targets (This month)" → 10
...
implement this UI for me as the landing page 